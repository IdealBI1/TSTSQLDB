CREATE TABLE [LND].[LND_EBS_HZ_CONTACT_POINTS] (
    [CONTACT_POINT_ID]             NVARCHAR (4000) NULL,
    [CONTACT_POINT_TYPE]           NVARCHAR (4000) NULL,
    [STATUS]                       NVARCHAR (4000) NULL,
    [OWNER_TABLE_NAME]             NVARCHAR (4000) NULL,
    [OWNER_TABLE_ID]               NVARCHAR (4000) NULL,
    ...
    [EDI_ID_NUMBER]                NVARCHAR (4000) NULL,
    ...
    [EDI_TP_HEADER_ID]             NVARCHAR (4000) NULL,
    [EDI_ECE_TP_LOCATION_CODE]     NVARCHAR (4000) NULL,
    [EMAIL_FORMAT]                 NVARCHAR (4000) NULL,
    [EMAIL_ADDRESS]                NVARCHAR (4000) NULL,
    [BEST_TIME_TO_CONTACT_START]   NVARCHAR (4000) NULL,
    [BEST_TIME_TO_CONTACT_END]     NVARCHAR (4000) NULL,
    [PHONE_CALLING_CALENDAR]       NVARCHAR (4000) NULL,
    [CONTACT_ATTEMPTS]             NVARCHAR (4000) NULL,
    [CONTACTS]                     NVARCHAR (4000) NULL,
    [DECLARED_BUSINESS_PHONE_FLAG] NVARCHAR (4000) NULL,
    [DO_NOT_USE_FLAG]              NVARCHAR (4000) NULL,
    [DO_NOT_USE_REASON]            NVARCHAR (4000) NULL,
    [LAST_CONTACT_DT_TIME]         NVARCHAR (4000) NULL,
    [PHONE_PREFERRED_ORDER]        NVARCHAR (4000) NULL,
    [PRIORITY_OF_USE_CODE]         NVARCHAR (4000) NULL,
    [TELEPHONE_TYPE]               NVARCHAR (4000) NULL,
    [TIME_ZONE]                    NVARCHAR (4000) NULL,
    [PHONE_TOUCH_TONE_TYPE_FLAG]   NVARCHAR (4000) NULL,
    [PHONE_AREA_CODE]              NVARCHAR (4000) NULL,
    [PHONE_COUNTRY_CODE]           NVARCHAR (4000) NULL,
    [PHONE_NUMBER]                 NVARCHAR (4000) NULL,
    [PHONE_EXTENSION]              NVARCHAR (4000) NULL,
    [PHONE_LINE_TYPE]              NVARCHAR (4000) NULL,
    [TELEX_NUMBER]                 NVARCHAR (4000) NULL,
    [WEB_TYPE]                     NVARCHAR (4000) NULL,
    [URL]                          NVARCHAR (4000) NULL,
    [CONTENT_SOURCE_TYPE]          NVARCHAR (4000) NULL,
    [RAW_PHONE_NUMBER]             NVARCHAR (4000) NULL,
    ...
    [CONTACT_POINT_PURPOSE]        NVARCHAR (4000) NULL,
    [PRIMARY_BY_PURPOSE]           NVARCHAR (4000) NULL,
    [TRANSPOSED_PHONE_NUMBER]      NVARCHAR (4000) NULL,
    [EFT_TRANSMISSION_PROGRAM_ID]  NVARCHAR (4000) NULL,
    [EFT_PRINTING_PROGRAM_ID]      NVARCHAR (4000) NULL,
    [EFT_USER_NUMBER]              NVARCHAR (4000) NULL,
    [EFT_SWIFT_CODE]               NVARCHAR (4000) NULL,
