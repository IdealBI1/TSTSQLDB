CREATE TABLE [HSTG].[HSTG_CA_SOLINE] (
    [So#]                          NVARCHAR (20)   NULL,
...
GO
CREATE NONCLUSTERED INDEX [IDX_HSTG_CA_SOLINE_CURRENT_RECORD_IS_DELETED]
    ON [HSTG].[HSTG_CA_SOLINE]([OMD_IS_RECORD_DELETED] ASC, [OMD_CURRENT_RECORD_INDICATOR] ASC)
    INCLUDE([So#], [Sol#], [Deliv Date]);
