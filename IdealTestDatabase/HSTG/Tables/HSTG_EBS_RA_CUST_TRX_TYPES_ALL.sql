CREATE TABLE [HSTG].[HSTG_EBS_RA_CUST_TRX_TYPES_ALL] (
...
GO
CREATE NONCLUSTERED INDEX [IX_HSTG_EBS_RA_CUST_TRX_TYPES_ALL_OMD_HASH_FULL_RECORD]
    ON [HSTG].[HSTG_EBS_RA_CUST_TRX_TYPES_ALL]([OMD_HASH_FULL_RECORD] ASC)
