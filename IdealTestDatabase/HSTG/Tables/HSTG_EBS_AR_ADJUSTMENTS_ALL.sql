CREATE TABLE [HSTG].[HSTG_EBS_AR_ADJUSTMENTS_ALL] (
...
GO
CREATE NONCLUSTERED INDEX [IX_HSTG_EBS_AR_ADJUSTMENTS_ALL_OMD_HASH_FULL_RECORD]
    ON [HSTG].[HSTG_EBS_AR_ADJUSTMENTS_ALL]([OMD_HASH_FULL_RECORD] ASC)
