CREATE TABLE [HSTG].[HSTG_EBS_MTL_SYSTEM_ITEMS_B] (
...
GO
CREATE NONCLUSTERED INDEX [IDX_HSTG_EBS_MTL_SYSTEM_ITEMS_B_ORGANIZATION_ID_SEGMENT1]
    ON [HSTG].[HSTG_EBS_MTL_SYSTEM_ITEMS_B]([ORGANIZATION_ID] ASC, [SEGMENT1] ASC, [OMD_CURRENT_RECORD_INDICATOR] ASC)
    INCLUDE([INVENTORY_ITEM_ID], [CREATION_DATE], [START_DATE_ACTIVE], [DESCRIPTION], [ATTRIBUTE2], [PRIMARY_UOM_CODE], [ATTRIBUTE17], [OMD_INSERT_DATETIME]);


GO
CREATE NONCLUSTERED INDEX [IDX_HSTG_EBS_MTL_SYSTEM_ITEMS_B_DELETED_CURRENT]
    ON [HSTG].[HSTG_EBS_MTL_SYSTEM_ITEMS_B]([OMD_IS_RECORD_DELETED] ASC, [OMD_CURRENT_RECORD_INDICATOR] ASC)
    INCLUDE([OMD_HASH_FULL_RECORD]);
