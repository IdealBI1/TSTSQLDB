...
Create PROCEDURE [STG].[LOAD_STG_EBS_HZ_PARTIES_backup]
AS 
BEGIN 
        ...
        /* Step 2:  IMPORT FROM LANDING TO STAGING*/
                ...
                SELECT * FROM (
                    SELECT 
                        ...
                        ,TRY_CONVERT(datetime,"CREATION_DATE",104) AS "CREATION_DATE"
                        ...
                        ,TRY_CONVERT(datetime,"LAST_UPDATE_DATE",104) AS "LAST_UPDATE_DATE"
                        ,CAST("PROGRAM_ID" AS float) AS "PROGRAM_ID"
                        ,TRY_CONVERT(datetime,"PROGRAM_UPDATE_DATE",104) AS "PROGRAM_UPDATE_DATE"
                        ,TRY_CONVERT(datetime,"WH_UPDATE_DATE",104) AS "WH_UPDATE_DATE"
                        ...
                        ,TRY_CONVERT(datetime,"LAST_ORDERED_DATE",104) AS "LAST_ORDERED_DATE"
