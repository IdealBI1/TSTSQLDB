...
CREATE PROCEDURE "STG"."LOAD_STG_CA_DLSMAN"
AS 
BEGIN 
...
SET NOCOUNT ON;
    ...
    EXEC "STG"."LOAD_STG_CA_DLSMAN";
    
    
    Source                   Destination           
    ---------------------    --------------------- 
    LND"."LND_CA_DLSMAN"    "STG"."STG_CA_DLSMAN" 
    ...
    */
    ...
    BEGIN TRY
        ...
        /* Step 1:  TRUNCATE STAGING TABLE*/
                TRUNCATE TABLE "STG"."STG_CA_DLSMAN";
        
        
        /* Step 2:  IMPORT FROM LANDING TO STAGING*/
                INSERT INTO "STG"."STG_CA_DLSMAN"
                (
                    "Spn"
                    ,"Salesperson Name"
                    ,"Sales 1"
                ...
                SELECT * FROM (
                    SELECT 
                        ...
                        ,CAST("SALESPERSON NAME" AS nvarchar(60) ) AS "SALESPERSON NAME"
                        ...
                        ,CAST("LOC" AS nvarchar(80) ) AS "LOC"
                        ,CAST("SALESPERSON EMAIL" AS nvarchar(500) ) AS "SALESPERSON EMAIL"
                        ,CAST("DIRECT PHONE" AS nvarchar(30) ) AS "DIRECT PHONE"
                        ,CAST("O" AS nvarchar(2) ) AS "O"
                        ,TRY_CONVERT(datetime2,"PwWarnDate",104) AS "PWWARNDATE"
                        ,CAST("FUNCTION ROLE TITLE" AS nvarchar(50) ) AS "FUNCTION ROLE TITLE"
                        ,TRY_CONVERT(datetime2,"PasswdDate",104) AS "PASSWDDATE"
                        ,TRY_CONVERT(datetime2,"Start Date",104) AS "START DATE"
                        ,TRY_CONVERT(datetime2,"Block Date",104) AS "BLOCK DATE"
