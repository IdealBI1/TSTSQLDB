...
CREATE PROCEDURE [STG].[LOAD_STG_EBS_MTL_PARAMETERS]
AS 
BEGIN 
...
SET NOCOUNT ON;
    ...
    EXEC "STG"."LOAD_STG_EBS_MTL_PARAMETERS";
    
    
    Source                                Destination                        
    ----------------------------------    ---------------------------------- 
    LND"."LND_EBS_MTL_PARAMETERS"    "STG"."STG_EBS_MTL_PARAMETERS" 
    ...
    */
    ...
    BEGIN TRY
        ...
        /* Step 1:  TRUNCATE STAGING TABLE*/
                TRUNCATE TABLE "STG"."STG_EBS_MTL_PARAMETERS";
        
        
        /* Step 2:  IMPORT FROM LANDING TO STAGING*/
                INSERT INTO "STG"."STG_EBS_MTL_PARAMETERS"
					("ORGANIZATION_ID", 
					"LAST_UPDATE_DATE", 
					"LAST_UPDATED_BY", 
					"CREATION_DATE", 
                ...
                SELECT * FROM (
                    ...
                    FROM "LND"."LND_EBS_MTL_PARAMETERS"
                    ) T 
