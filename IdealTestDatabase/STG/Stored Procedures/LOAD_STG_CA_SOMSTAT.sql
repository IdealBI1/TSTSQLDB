...
CREATE PROCEDURE "STG"."LOAD_STG_CA_SOMSTAT"
AS 
BEGIN 
...
SET NOCOUNT ON;
    ...
    EXEC "STG"."LOAD_STG_CA_SOMSTAT";
    
    
    Source                    Destination            
    ----------------------    ---------------------- 
    LND"."LND_CA_SOMSTAT"    "STG"."STG_CA_SOMSTAT" 
    ...
    */
    ...
    BEGIN TRY
        ...
        /* Step 1:  TRUNCATE STAGING TABLE*/
                TRUNCATE TABLE "STG"."STG_CA_SOMSTAT";
        
        
        /* Step 2:  IMPORT FROM LANDING TO STAGING*/
                INSERT INTO "STG"."STG_CA_SOMSTAT"
                (
                    "So#"
                    ,"Cust#"
                    ,"Order Date"
